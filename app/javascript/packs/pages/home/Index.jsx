...
function Index() {
    ...
    return (
      <div className="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <div className="w-full lg:w-1/2 flex flex-col justify-center lg:items-start overflow-y-hidden">
              <a className="text-gray-500 no-underline hover:no-underline" href="#">&copy; Astrocket 2020</a>
          </div>
          <div className="w-full lg:w-1/2 pt-16 pb-6 text-sm text-center md:text-left fade-in">
              <h1
                className="my-4 text-3xl md:text-5xl text-green-500 font-bold leading-tight text-center md:text-left slide-in-bottom-h1">
                  {currencyFormat(40000)}
              </h1>
              <p
