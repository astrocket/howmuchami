...
function Index() {
    ...
    return (
      <div className="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <div className="w-1/2 flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
              <h1
          ...
          <div className="w-1/2 w-full pt-16 pb-6 text-sm text-center md:text-left fade-in">
